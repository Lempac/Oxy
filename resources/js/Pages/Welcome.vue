...
import {FaBook, MdCallendRound, MdMessageRound, MdScreenshareRound} from "oh-vue-icons/icons";
import {addIcons} from "oh-vue-icons";
import ApplicationLogo from "@/Components/ApplicationLogo.vue";

addIcons(MdMessageRound, MdCallendRound, MdScreenshareRound, FaBook);
        ...
        <main class="flex-1 flex flex-col items-center justify-center">
            ...
            <div class="flex justify-center items-center space-x-8">
                <div class="card bg-base-200 text-base-content p-6 w-80 text-center border border-base-300">
                    <v-icon class="mx-auto mb-4" name="md-message-round" scale="3" animation="float" speed="slow"/>
                ...
                <div class="card bg-base-200 text-base-content p-6 w-80 text-center border border-base-300">
                    <v-icon class="mx-auto mb-4" name="md-callend-round" scale="3" animation="float" speed="slow"/>
                ...
                <div class="card bg-base-200 text-base-content p-6 w-80 text-center border border-base-300">
                    <v-icon class="mx-auto mb-4" name="md-screenshare-round" scale="3" animation="float" speed="slow"/>
