                    ...
                    <div class="flex lg:justify-center lg:col-start-2">
                        <a href="/welcome" class="block">
                            <svg
                                ...
                                fill="none"
                            >
                                <image href="/images/ox.jpg" x="-10" y="-19" height="110" width="110" />
                            </svg>
                        </a>
                    </div>
                    ...
                    <div class="relative flex items-center gap-6 lg:items-end">
                        <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                            ...
                            <div class="pt-3 sm:pt-5 lg:pt-0">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    CO2 lets users easily communicate with other users in a fast and convenient way
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    Creating serves lets you easy communicate with multiple people and work with several projects at the same time. 
                                </p>
                            </div>
                        </a>
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed">
                                    ...
                                    <a
                                        ...
                                        >kanban board</a
                                    >,
                                    helps you take your projects in simple steps. The kanban board let's you seperate everything you are doing, done and need to do. 
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div v-if="showRegisterPopup" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white p-8 rounded shadow-lg w-full max-w-md dark:bg-slate-900">
                ...
                <form @submit.prevent="submitRegister">
                    ...
                    <div class="flex justify-between items-center">
                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md" :disabled="form.processing">
                            Register
                        </button>
