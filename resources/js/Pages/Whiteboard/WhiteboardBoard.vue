...
import { FaEraser, FaRegSquare, FaRedo, FaRegCircle, FaUndo } from "vue-icons-plus/fa";
import { MdDeleteOutline, MdAdsClick, MdFormatColorFill, MdHorizontalRule } from "vue-icons-plus/md";
