...
const createMessage = async () => {
    ...
    try {
        ...
        router.post(create.url(selectedChannel!.slug), form.data(), { preserveScroll: true, onSuccess: () => { clearFile(); hasError.value = false; } })
...
const editMessage = async () => {
    if (messageIdToEdit.value !== null) {
        router.patch(edit.url(messageIdToEdit.value), {mdata: form.mdata}, { preserveScroll: true, onSuccess: () => { messageModal.value?.close(); form.reset(); }});
